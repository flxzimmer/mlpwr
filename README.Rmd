...
This is a basic demonstration to the mlpwr pacakge by going through a toy example. We want to obtain the sample size necessary for a mean comparison using an one-sample t-test. 
