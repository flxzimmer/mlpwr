...
-   evaluations: The number of evaluations of the dgfun that should be performed before returning a result.
...
Once a termination criterion is met (e.g. the number of permissible dgfun evaluation specified with evaluations), the algorithm is terminated.
