...
A similar function for a poisson model is implemented in the example simulation function of mlpwr and can be seen [here](https://cran.r-project.org/web/packages/mlpwr/vignettes/simulation_functions.html).
