...
#   re3 =  NULL
#   re4 =  ss.find(gauss.pred,runfun=runfun,design=design,goal=goal,goal.ci=goal.ci,budget=1000, seed=seed,cost=cost,dat=startdat,fixed_cost=fixed_cost)
#
...
re = 0
  ...
  file_string=paste0("seedsx/seed_",seed,"_fun_",fun_nr,"_task",task,".Rdata")
